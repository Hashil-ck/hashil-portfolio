    ...
    return (
        ...
        >
            ...
            >
                ...
                <p style={{ color: '#a1a1aa', fontSize: '15px', margin: '0 0 20px 0', lineHeight: '1.5' }}>
                    ...
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1px' }}>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                            ...
                            <input
                                ...
                                required
                            />
                            <ValidationError prefix="Email" field="email" errors={state.errors} style={{ color: '#ef4444', fontSize: '13px', marginTop: '2px' }} />
                        </div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                            ...
                            <textarea
                                ...
                                style={{
                                    background: '#121212', color: '#fff', border: '1px solid rgba(255,255,255,0.1)',
                                    padding: '16px', minHeight: '80px', height: "120px", borderRadius: '12px',
                                ...
                                required
                            />
                            <ValidationError prefix="Message" field="message" errors={state.errors} style={{ color: '#ef4444', fontSize: '13px', marginTop: '2px' }} />
                        </div>
